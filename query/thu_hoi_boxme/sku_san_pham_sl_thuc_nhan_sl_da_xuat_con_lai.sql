...
id,
    ...
    ( CASE 
        WHEN tinh_trang_san_pham LIKE '%hết hạn%' 
          OR tinh_trang_san_pham LIKE '%đã qua sử dụng%' 
    ...
    hsd_tieu_chuan_thang as 'HSD Tiêu chuẩn (tháng)',
    hsd_con_lai_thang as 'HSD Còn lại (tháng)',
    pct_hsd_con_lai as '% HSD Còn lại',
