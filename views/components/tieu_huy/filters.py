...
def render_filters():
    ...
    with engine.begin() as conn:
        ...
        q_ngay = load_query("tieu_huy/ngay_cap_nhap_FILTER.sql")
        ...
        df_phan_loai = pd.read_sql(text(q_phan_loai), conn)
    ...
    return selected_ngay, selected_phan_loai, selected_skus